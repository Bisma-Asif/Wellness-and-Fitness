...
export default function About() {
  ...
  const videoSources = [
    ...
    new URL('../videos/floating-videos/3327959.mp4', import.meta.url).href,
    new URL('../videos/floating-videos/4536085.mp4', import.meta.url).href,
    new URL('../videos/floating-videos/4608975.mp4', import.meta.url).href,
  ]
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          <div className="group p-8 rounded-3xl bg-white/40 backdrop-blur-sm border border-purple-200/30 hover:shadow-xl hover:shadow-purple-200 transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-purple-800 leading-relaxed">
              AI-driven insights that adapt to your unique wellness journey and
          ...
          <div className="group p-8 rounded-3xl bg-white/40 backdrop-blur-sm border border-purple-200/30 hover:shadow-xl hover:shadow-purple-200 transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-purple-800 leading-relaxed">
              Every feature is crafted with empathy, putting your well-being and
          ...
          <div className="group p-8 rounded-3xl bg-white/40 backdrop-blur-sm border border-purple-200/30 hover:shadow-xl hover:shadow-purple-200 transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-purple-800 leading-relaxed">
              Seamlessly connect physical fitness, mental health, and emotional
              wellness in one unified ecosystem.
            </p>
          </div>
        </div>
      </div>
